...
#define GAME_SCENE_HEADER
    ...
    namespace example
    {
        ...
        private:
            ...
            static constexpr float   ball_speed = 15.f;         ///< Velocidad a la que se mueve la bola.
            static constexpr float player_speed = 10.f;         ///< Velocidad a la que se mueven ambos jugadores.
        ...
        private:
            ...
            //Added as exercise: Instantate walls, instantiate projectile
            Sprite       * wall;                                ///< Puntero al sprite de la lista de sprites que representa un muro.
            bool           enableWallCollisions;

            Sprite        *projectile ;                       ///< Array de punteros al sprite de la lista de sprites que representan proyectiles.
            bool           enableProjectileCollisions;
            bool           instantiatedWall;
